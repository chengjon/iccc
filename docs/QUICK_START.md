...
This guide will help you get iCCC (i-Claude Code CLI) up and running in under 10 minutes.
...
Expected output:
```
[ 'projects', 'agents', 'tasks', 'events', 'sessions' ]
```
...
tests/agents/test_meta_agent.py ................            [  8%]
tests/agents/test_subagent.py ......................        [ 19%]
tests/agents/test_templates.py ....................         [ 29%]
tests/api/test_agents.py .................                  [ 37%]
tests/api/test_projects.py .................                [ 45%]
tests/api/test_tasks.py .................                   [ 53%]
tests/hooks/scripts/test_auto_test.py ..........            [ 58%]
tests/hooks/scripts/test_agent_coordinator.py ........      [ 62%]
tests/planning/test_adaptive.py ......................      [ 73%]
tests/planning/test_htn.py ................                 [ 81%]
tests/planning/test_strips.py ................              [ 89%]
tests/utils/test_file_locks.py ..........                   [ 94%]
tests/utils/test_summarizer.py ............                 [100%]
...
1. **Multi-Agent Orchestration**: Learn how to coordinate multiple AI agents working in parallel
   - Read: `docs/MULTI_AGENT_GUIDE.md`

2. **Planning Systems**: Understand HTN, STRIPS, and adaptive replanning
   - Read: `docs/PLANNING.md`

3. **Git Worktrees**: Master agent isolation with Git worktrees
   - Read: `docs/WORKTREES.md`

4. **Claude Hooks**: Build custom automation with hooks
   - Read: `docs/HOOKS.md`

5. **REST API**: Integrate iCCC into your applications
   - Explore: `http://localhost:8000/docs`

6. **Advanced Configuration**: Customize model selection, rate limits, and quality gates
